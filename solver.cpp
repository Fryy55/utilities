...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        printf("Unexpected error occurred: expected 512 iterations; found %llu. Please report this issue via the repository's Issues tab.\n\nPress ENTER to close.", e);
        getch();
        exit(0);
    }
    ...
    try {
        ...
        printf("Unexpected error occurred: expected 19683 iterations; found %llu. Please report this issue via the repository's Issues tab.\n\nPress ENTER to close.", e);
        getch();
        exit(0);
    }
