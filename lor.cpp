...
unsigned int depth; // 17 is minimal depth, 16 doesn't reach 1 iteration
const unsigned int BASE = 5;
const unsigned int NTABLE = 19687;
...
int main() {
    ...
    printf("\nInitialized...\n");
    rec("000000000", 0);
    printf("%d iterations found, 19683 to prove. Depth: %d", s.size(), depth);
